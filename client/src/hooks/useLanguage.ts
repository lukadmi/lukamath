...
export const translations = {
  ...
  hr: {
    ...
    "app_features.features_subtitle": "Vaš osobni sustav za upravljanje domaćim zadacima dizajniran da vas drži na pravom putu s zadacima, pitanjima i napretkom uz Luku kao vašeg privatnog nastavnika.",
    ...
    // Student App
    "app.homework": "Domaći zadaci",
    "app.questions": "Pitanja",
    "app.progress": "Napredak",
    "app.calendar": "Kalendar",
    "app.welcome": "Dobrodošli,",
    "app.homework_empty": "Trenutno nemate dodijeljenih domaćih zadataka",
